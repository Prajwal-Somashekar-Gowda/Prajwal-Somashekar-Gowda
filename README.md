...
I’m a Software Engineer passionate about building scalable systems, distributed backend services, and AI-driven cloud solutions. With hands-on experience in AWS, Azure, Kubernetes, and Terraform, I focus on designing high-availability platforms that deliver performance, security, and measurable impact. I love transforming ideas into reliable, production-grade systems through clean architecture and automation.

🌟 What I’m Working On:
- Architecting cloud-native microservices and data pipelines using AWS Lambda, Docker, and Kubernetes.
- Developing backend APIs and full-stack applications with Python, Node.js, and React.js.
- Integrating AI/ML models securely using AWS Bedrock and event-driven architectures.
- Enhancing observability with CloudWatch, Prometheus, and Grafana for latency and reliability insights.
...
- Building data-intensive applications with event-driven design
- Best practices in CI/CD, observability, and DevSecOps
- Crafting interactive full-stack experiences using React.js and Node.js
